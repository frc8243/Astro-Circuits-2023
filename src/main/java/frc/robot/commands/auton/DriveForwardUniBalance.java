...
public class DriveForwardUniBalance extends SequentialCommandGroup {
  /** Creates a new DriveforwardBalance. */
  public DriveForwardUniBalance(Drivetrain drivetrain, Claw claw, PID_ProfileArm arm) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new DriveForwardGivenDistanceUsingTime(-3.25 , drivetrain),
      new UniAutoBalance(drivetrain)
    );
  }
}
